 ...
 * 
 */
@WebServiceClient(name = "EmployeeService", targetNamespace = "http://www.bcit.ca/a00057006ws/employee/xml", wsdlLocation = "file:/Users/mdoucette/Dropbox/Development/BCIT/Comp4655/Assignments/Assignment02/A00057006ws/EmployeeService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://www.bcit.ca/a00057006ws/employee/xml", "EmployeeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/mdoucette/Dropbox/Development/BCIT/Comp4655/Assignments/Assignment02/A00057006ws/EmployeeService.wsdl");
    ...
    public EmployeeServicePort getEmployeeServicePort() {
        return super.getPort(new QName("http://www.bcit.ca/a00057006ws/employee/xml", "EmployeeServicePort"), EmployeeServicePort.class);
    }
    ...
    public EmployeeServicePort getEmployeeServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.bcit.ca/a00057006ws/employee/xml", "EmployeeServicePort"), EmployeeServicePort.class, features);
    }
